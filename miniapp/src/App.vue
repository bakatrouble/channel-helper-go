...
onMounted(() => {
    ...
    console.log('initDataRawValue:', initDataRawValue);
...
.btn
    ...
    &:hover
        background: color-mix(in oklab, var(--tg-theme-button-color), white 10%)
    ...
    &.outline
        ...
        &:hover
            background: color-mix(in oklab, var(--tg-theme-button-color), white 10%)
            border-color: color-mix(in oklab, var(--tg-theme-button-color), white 10%)
            color: var(--tg-theme-button-text-color)
